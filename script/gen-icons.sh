...
# Android, Store logos) into apps/drugitems-app/icons/.
#
...
cargo tauri icon icon-master.svg -o apps/drugitems-app/icons

echo "All icons generated in apps/drugitems-app/icons/."